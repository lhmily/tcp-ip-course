<!-- COURSE_COMPONENT:ethernet-arp-hero START -->
# Lesson 02: Ethernet and ARP

| Lesson track | Structured fallback |
|---|---|
| Foundations | Parse Ethernet II and Ethernet/IPv4 ARP, then build a deterministic broadcast request. |
<!-- COURSE_COMPONENT:ethernet-arp-hero END -->

<!-- COURSE_COMPONENT:ethernet-arp-outcomes START -->
## Learning objectives
...
<!-- COURSE_COMPONENT:ethernet-arp-outcomes END -->
...
<!-- COURSE_COMPONENT:ethernet-arp-contract START -->
## Exercise
...
<!-- COURSE_COMPONENT:ethernet-arp-contract END -->
...
<!-- COURSE_COMPONENT:ethernet-arp-safety START -->
...
<!-- COURSE_COMPONENT:ethernet-arp-safety END -->
