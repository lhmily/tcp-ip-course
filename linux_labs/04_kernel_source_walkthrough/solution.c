...
static const tcpip_linux_l04_symbol tcpip_linux_l04_symbols[] = {
    L04_SYMBOL(TCPIP_LINUX_L04_NETIF_RECEIVE_SKB, "netif_receive_skb", "netif_receive_skb",
               "net/core/dev.c", 5598U, "Enter the receive core with one sk_buff."),
    L04_SYMBOL(TCPIP_LINUX_L04_NETIF_RECEIVE_SKB_ONE_CORE, "__netif_receive_skb_one_core",
               "__netif_receive_skb_one_core", "net/core/dev.c", 5527U,
               "Run the protocol receive path for one packet."),
    L04_SYMBOL(TCPIP_LINUX_L04_IP_RCV, "ip_rcv", "ip_rcv", "net/ipv4/ip_input.c", 568U,
               "Validate an IPv4 packet before Netfilter ingress."),
    L04_SYMBOL(TCPIP_LINUX_L04_IP_RCV_FINISH, "ip_rcv_finish", "ip_rcv_finish",
               "net/ipv4/ip_input.c", 449U, "Finish IPv4 receive processing and route the packet."),
    L04_SYMBOL(TCPIP_LINUX_L04_IP_ROUTE_INPUT_NOREF, "ip_route_input_noref",
               "ip_route_input_noref", "net/ipv4/route.c", 2568U,
    ...
    L04_SYMBOL(TCPIP_LINUX_L04_IP_ROUTE_INPUT_SLOW, "ip_route_input_slow", "ip_route_input_slow",
               "net/ipv4/route.c", 2184U, "Perform the uncached IPv4 input route lookup."),
    L04_SYMBOL(TCPIP_LINUX_L04_IP_LOCAL_DELIVER, "ip_local_deliver", "ip_local_deliver",
               "net/ipv4/ip_input.c", 251U, "Reassemble if needed and enter local delivery hooks."),
    L04_SYMBOL(TCPIP_LINUX_L04_IP_LOCAL_DELIVER_FINISH, "ip_local_deliver_finish",
               "ip_local_deliver_finish", "net/ipv4/ip_input.c", 229U,
               "Dispatch a locally delivered datagram to its IP protocol."),
    L04_SYMBOL(TCPIP_LINUX_L04_TCP_V4_RCV, "tcp_v4_rcv", "tcp_v4_rcv", "net/ipv4/tcp_ipv4.c",
               2310U, "Receive and validate an IPv4 TCP segment."),
    L04_SYMBOL(TCPIP_LINUX_L04_INET_LOOKUP_SKB, "__inet_lookup_skb", "__inet_lookup_skb",
               "include/net/inet_hashtables.h", 538U,
    ...
    L04_SYMBOL(TCPIP_LINUX_L04_INET_LOOKUP_ESTABLISHED, "__inet_lookup_established",
               "__inet_lookup_established", "include/net/inet_hashtables.h", 375U,
    ...
    L04_SYMBOL(TCPIP_LINUX_L04_TCP_RCV_ESTABLISHED, "tcp_rcv_established", "tcp_rcv_established",
               "net/ipv4/tcp_input.c", 5893U, "Process a segment on the TCP established fast or slow path."),
    L04_SYMBOL(TCPIP_LINUX_L04_TCP_ACK, "tcp_ack", "tcp_ack", "net/ipv4/tcp_input.c", 3843U,
               "Apply an acknowledgment to TCP sender state."),
    L04_SYMBOL(TCPIP_LINUX_L04_SOCK_SENDMSG, "sock_sendmsg", "sock_sendmsg", "net/socket.c", 721U,
               "Enter protocol sendmsg through the socket layer."),
    L04_SYMBOL(TCPIP_LINUX_L04_TCP_SENDMSG, "tcp_sendmsg", "tcp_sendmsg", "net/ipv4/tcp.c", 1304U,
    ...
    L04_SYMBOL(TCPIP_LINUX_L04_TCP_SENDMSG_LOCKED, "tcp_sendmsg_locked", "tcp_sendmsg_locked",
               "net/ipv4/tcp.c", 1260U, "Queue application bytes into TCP write buffers."),
    L04_SYMBOL(TCPIP_LINUX_L04_TCP_WRITE_XMIT, "tcp_write_xmit", "tcp_write_xmit",
               "net/ipv4/tcp_output.c", 2693U, "Choose queued TCP segments eligible for transmission."),
    L04_SYMBOL(TCPIP_LINUX_L04_TCP_TRANSMIT_SKB, "tcp_transmit_skb", "tcp_transmit_skb",
               "net/ipv4/tcp_output.c", 1169U, "Construct TCP headers and hand a segment to IP."),
    L04_SYMBOL(TCPIP_LINUX_L04_IP_ROUTE_OUTPUT_FLOW, "ip_route_output_flow", "ip_route_output_flow",
               "net/ipv4/route.c", 2857U, "Resolve an IPv4 output route for a flow."),
    L04_SYMBOL(TCPIP_LINUX_L04_IP_QUEUE_XMIT, "ip_queue_xmit", "ip_queue_xmit",
               "include/net/ip.h", 248U, "Public transport helper for IPv4 queueing."),
    L04_SYMBOL(TCPIP_LINUX_L04___IP_QUEUE_XMIT, "__ip_queue_xmit", "__ip_queue_xmit",
               "net/ipv4/ip_output.c", 468U, "Build the IPv4 header and enter local output."),
    L04_SYMBOL(TCPIP_LINUX_L04_IP_LOCAL_OUT, "ip_local_out", "ip_local_out",
               "net/ipv4/ip_output.c", 122U, "Run local IPv4 output hooks."),
    L04_SYMBOL(TCPIP_LINUX_L04_IP_OUTPUT, "ip_output", "ip_output", "net/ipv4/ip_output.c", 432U,
    ...
    L04_SYMBOL(TCPIP_LINUX_L04_IP_FINISH_OUTPUT, "ip_finish_output", "ip_finish_output",
               "net/ipv4/ip_output.c", 318U, "Apply final IPv4 output handling before neighbor output."),
    L04_SYMBOL(TCPIP_LINUX_L04___DEV_QUEUE_XMIT, "__dev_queue_xmit", "__dev_queue_xmit",
               "net/core/dev.c", 4341U, "Queue an sk_buff to device traffic control or a driver."),
    L04_SYMBOL(TCPIP_LINUX_L04_TCP_GET_INFO, "tcp_get_info", "tcp_get_info", "net/ipv4/tcp.c", 3995U,
...
static const tcpip_linux_l04_edge tcpip_linux_l04_edges[] = {
    ...
    {TCPIP_LINUX_L04_IP_ROUTE_INPUT_SLOW, TCPIP_LINUX_L04_IP_LOCAL_DELIVER},
    {TCPIP_LINUX_L04_IP_LOCAL_DELIVER, TCPIP_LINUX_L04_IP_LOCAL_DELIVER_FINISH},
    ...
    {TCPIP_LINUX_L04_TCP_TRANSMIT_SKB, TCPIP_LINUX_L04_IP_QUEUE_XMIT},
    {TCPIP_LINUX_L04_IP_ROUTE_OUTPUT_FLOW, TCPIP_LINUX_L04_IP_QUEUE_XMIT},
...
tcpip_linux_l04_status tcpip_linux_l04_format_source_url(
  ...
  *written = (size_t)required;
  if ((size_t)required >= output_capacity) {
