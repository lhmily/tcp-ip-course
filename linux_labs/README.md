<!-- COURSE_COMPONENT:linux-hero START -->
...
[Build the student labs](#prerequisites-and-workflow) · [Start Linux Lab 01](01_epoll_event_loop/README.md)
<!-- COURSE_COMPONENT:linux-hero END -->
...
<!-- COURSE_COMPONENT:linux-prerequisites START -->
...
The track moves from stable user-space interfaces toward internal implementation paths. You will practice local, unprivileged observation while keeping UAPI contracts distinct from kernel implementation references.
<!-- COURSE_COMPONENT:linux-prerequisites END -->

<!-- COURSE_COMPONENT:linux-curriculum START -->
## Labs
...
<!-- COURSE_COMPONENT:linux-curriculum END -->
...
<!-- COURSE_COMPONENT:linux-safety START -->
## Safety boundary
...
<!-- COURSE_COMPONENT:linux-safety END -->
